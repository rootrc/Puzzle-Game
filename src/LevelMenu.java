        ...
        g2d.setStroke(new BasicStroke(8f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER));
            ...
            for (int x = 0; x < 6; x ++) {
                for (int y = 0; y < 4; y ++) {
                    ...
                    int num = 1 + x + y * 6;
                    if (num < 10) {
                        g2d.drawString(String.valueOf(num), x * 128 + 166, y * 144 + 202);
                    } else if (num < 20){
                        g2d.drawString(String.valueOf(num), x * 128 + 146, y * 144 + 202);
                    } else {
                        g2d.drawString(String.valueOf(num), x * 128 + 150, y * 144 + 202);
                    }
                }
            }
            if (starsCollected[0]) {
